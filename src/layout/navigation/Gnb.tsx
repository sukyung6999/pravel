...
const Gnb = () => {
  return (
    <nav className="fixed bottom-0 max-w-[780px] w-full before:content-[''] before:w-full before:h-[130px] before:absolute before:bottom-0 before:left-0 before:bg-gradient-to-t from-white to-transparent">
