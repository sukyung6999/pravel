...
const AddOption = ({ closeAddOption, openWishList }: AddOptionProps) => {
  return (
    <div className="modal-content fixed bottom-0 left-0 w-full pt-[10px] pb-[41px] z-10 bg-white animate-modalUp modal rounded-[20px_20px_0_0] shadow-[0px_0px_20px_0px_#00000020]">
      <button
