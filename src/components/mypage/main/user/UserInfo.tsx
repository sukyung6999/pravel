  ...
  return (
    <div className="mt-10 pb-40">
      ...
      <div className="mt-[10px] p-5 bg-white rounded-xl">
        ...
        <Link
          className="py-[15px] flex items-center justify-between text-[14px] tracting-[-2%] font-semibold text-gray-600"
          href=""
        >
          프로필 / 닉네임 수정
        ...
        <Link
          className="pt-[15px] flex items-center justify-between text-[14px] tracting-[-2%] font-semibold text-gray-600"
          href=""
        >
          비밀번호 수정
          <i className="ico_pravel ico_right_gray_arrow24" />
